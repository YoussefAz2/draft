...
export function ResultsView({
  ...
  const isVictory = winnerId === currentUserId
  const isDefeat = Boolean(winnerId && winnerId !== currentUserId)
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center justify-center gap-3">
              <Sparkles className={cn("size-5", isVictory && "animate-pulse")} />
